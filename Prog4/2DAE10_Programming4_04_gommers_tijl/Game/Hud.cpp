	...
	, std::vector<std::shared_ptr<TG::Texture2D>> vTextures, std::shared_ptr<TG::Font> font)
{
	...
	AddComponent<ScoreComponent>(this, vCharactersPlayer2, m_mTextRenderRefrences["score"]);
	...
	AddComponent<HealthComponent>(this, vCharactersPlayer2[0], vHearthsPlayer2);
